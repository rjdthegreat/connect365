...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { division: @classroom.division, school_id: @classroom.school_id, standard: @classroom.standard }
    end
  ...
  test "should update classroom" do
    patch :update, id: @classroom, classroom: { division: @classroom.division, school_id: @classroom.school_id, standard: @classroom.standard }
    assert_redirected_to classroom_path(assigns(:classroom))
  end
